...
<xs:schema elementFormDefault="qualified" xmlns="http://schemas.microsoft.com/MobileDevice/DM" targetNamespace="http://schemas.microsoft.com/MobileDevice/DM" xmlns:xs="http://www.w3.org/2001/XMLSchema">
      ...
      <xs:element minOccurs="0" maxOccurs="1" name="List">
        ...
        <xs:complexType>
          <xs:attribute name="Delimiter" type="xs:string" use="required">
            <xs:annotation>
              <xs:documentation>This attribute details the delimiter used for the list of values.</xs:documentation>
            </xs:annotation>
          </xs:attribute>
        </xs:complexType>
      </xs:element>
  ...
  <xs:element name="AdmxBacked">
    <xs:annotation>
      <xs:documentation>This tag indicates the relevant details for the corresponding ADMX policy for this node.</xs:documentation>
    </xs:annotation>
    <xs:complexType>
