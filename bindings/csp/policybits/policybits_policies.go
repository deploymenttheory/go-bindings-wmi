...
var BandwidthThrottlingEndTime = csp.Policy{
	...
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Vendor/MSFT/Policy/Config", Property: "BandwidthThrottlingEndTime"},
}
...
var BandwidthThrottlingStartTime = csp.Policy{
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "Range"},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Vendor/MSFT/Policy/Config", Property: "BandwidthThrottlingStartTime"},
}
...
var BandwidthThrottlingTransferRate = csp.Policy{
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "Range"},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Vendor/MSFT/Policy/Config", Property: "BandwidthThrottlingTransferRate"},
}
...
var CostedNetworkBehaviorBackgroundPriority = csp.Policy{
	...
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Vendor/MSFT/Policy/Config", Property: "CostedNetworkBehaviorBackgroundPriority"},
}
...
var CostedNetworkBehaviorForegroundPriority = csp.Policy{
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "ENUM", Enum: []csp.EnumValue{{Value: "1", Description: "Always transfer"}, {Value: "2", Description: "Transfer unless roaming"}, {Value: "3", Description: "Transfer unless surcharge applies (when not roaming or over cap)"}, {Value: "4", Description: "Transfer unless nearing limit (when not roaming or nearing cap)"}, {Value: "5", Description: "Transfer only if unconstrained"}}},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Vendor/MSFT/Policy/Config", Property: "CostedNetworkBehaviorForegroundPriority"},
}
...
var JobInactivityTimeout = csp.Policy{
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "Range"},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Vendor/MSFT/Policy/Config", Property: "JobInactivityTimeout"},
}
