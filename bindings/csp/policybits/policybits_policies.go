...
var BandwidthThrottlingEndTime = csp.Policy{
	...
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Device/Vendor/MSFT/Policy/Config", Property: "BandwidthThrottlingEndTime"},
}

// BandwidthThrottlingStartTime: This policy specifies the bandwidth throttling start time that Background Intelligent Transfer Service (BITS) uses for background transfers. This policy setting does not affect foreground transfers. This policy is based on the 24-hour clock. Value type is integer. Default value is 8 (8 am). Supported value range: 0 - 23You can specify a limit to use during a specific time interval and at all other times. For example, limit the use of network bandwidth to 10 Kbps from 8:00 A. M. to 5:00 P. M. , and use all available unused bandwidth the rest of the day's hours. Using the three policies together (BandwidthThrottlingStartTime, BandwidthThrottlingEndTime, BandwidthThrottlingTransferRate), BITS will limit its bandwidth usage to the specified values. You can specify the limit in kilobits per second (Kbps). If you specify a value less than 2 kilobits, BITS will continue to use approximately 2 kilobits. To prevent BITS transfers from occurring, specify a limit of 0. If you disable or do not configure this policy setting, BITS uses all available unused bandwidth. Note: You should base the limit on the speed of the network link, not the computer's network interface card (NIC). This policy setting does not affect peer caching transfers between peer computers (it does affect transfers from the origin server); the Limit the maximum network bandwidth used for Peercaching policy setting should be used for that purpose. Consider using this setting to prevent BITS transfers from competing for network bandwidth when the client computer has a fast network card (10Mbs), but is connected to the network via a slow link (56Kbs).
var BandwidthThrottlingStartTime = csp.Policy{
	Name:       "BandwidthThrottlingStartTime",
	URI:        "./Device/Vendor/MSFT/Policy/Config/BITS/BandwidthThrottlingStartTime",
	Format:     "int",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	Default:    "8",
	MinOSBuild: "10.0.17763",
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "Range"},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Device/Vendor/MSFT/Policy/Config", Property: "BandwidthThrottlingStartTime"},
}

// BandwidthThrottlingTransferRate: This policy specifies the bandwidth throttling transfer rate in kilobits per second (Kbps) that Background Intelligent Transfer Service (BITS) uses for background transfers. This policy setting does not affect foreground transfers. Value type is integer. Default value is 1000. Supported value range: 0 - 4294967200. You can specify a limit to use during a specific time interval and at all other times. For example, limit the use of network bandwidth to 10 Kbps from 8:00 A. M. to 5:00 P. M. , and use all available unused bandwidth the rest of the day's hours. Using the three policies together (BandwidthThrottlingStartTime, BandwidthThrottlingEndTime, BandwidthThrottlingTransferRate), BITS will limit its bandwidth usage to the specified values. You can specify the limit in kilobits per second (Kbps). If you specify a value less than 2 kilobits, BITS will continue to use approximately 2 kilobits. To prevent BITS transfers from occurring, specify a limit of 0. If you disable or do not configure this policy setting, BITS uses all available unused bandwidth. Note: You should base the limit on the speed of the network link, not the computer's network interface card (NIC). This policy setting does not affect peer caching transfers between peer computers (it does affect transfers from the origin server); the Limit the maximum network bandwidth used for Peercaching policy setting should be used for that purpose. Consider using this setting to prevent BITS transfers from competing for network bandwidth when the client computer has a fast network card (10Mbs), but is connected to the network via a slow link (56Kbs).
var BandwidthThrottlingTransferRate = csp.Policy{
	Name:       "BandwidthThrottlingTransferRate",
	URI:        "./Device/Vendor/MSFT/Policy/Config/BITS/BandwidthThrottlingTransferRate",
	Format:     "int",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	Default:    "1000",
	MinOSBuild: "10.0.17763",
...
var CostedNetworkBehaviorForegroundPriority = csp.Policy{
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "ENUM", Enum: []csp.EnumValue{{Value: "1", Description: "Always transfer"}, {Value: "2", Description: "Transfer unless roaming"}, {Value: "3", Description: "Transfer unless surcharge applies (when not roaming or over cap)"}, {Value: "4", Description: "Transfer unless nearing limit (when not roaming or nearing cap)"}, {Value: "5", Description: "Transfer only if unconstrained"}}},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Device/Vendor/MSFT/Policy/Config", Property: "CostedNetworkBehaviorForegroundPriority"},
}
...
var JobInactivityTimeout = csp.Policy{
	Name:       "JobInactivityTimeout",
	URI:        "./Device/Vendor/MSFT/Policy/Config/BITS/JobInactivityTimeout",
	Format:     "int",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	Default:    "90",
	MinOSBuild: "10.0.17763",
	...
	Editions:   "0x4;0x1B;0x30;0x31;0x48;0x54;0x62;0x63;0x64;0x65;0x79;0x7A;0x7D;0x7E;0x81;0x82;0x8A;0x8B;0xA1;0xA2;0xA4;0xA5;0xAB;0xAC;0xAF;0xBC;0xBF;0xCA;0xCB;0xCD;0xCF;",
	Allowed:    &csp.Allowed{Type: "Range"},
	Bridge:     &csp.Bridge{ConfigClass: "MDM_Policy_Config01_BITS02", ResultClass: "MDM_Policy_Result01_BITS02", InstanceID: "BITS", ParentID: "./Device/Vendor/MSFT/Policy/Config", Property: "JobInactivityTimeout"},
}
