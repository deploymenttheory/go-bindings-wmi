...
var AllowArchiveScanning = csp.Policy{
...
var AllowBehaviorMonitoring = csp.Policy{
...
var AllowCloudProtection = csp.Policy{
...
var AllowEmailScanning = csp.Policy{
...
var AllowFullScanOnMappedNetworkDrives = csp.Policy{
...
var AllowFullScanRemovableDriveScanning = csp.Policy{
...
var AllowIOAVProtection = csp.Policy{
...
var AllowIntrusionPreventionSystem = csp.Policy{
...
var AllowOnAccessProtection = csp.Policy{
...
var AllowRealtimeMonitoring = csp.Policy{
...
var AllowScanningNetworkFiles = csp.Policy{
...
var AllowScriptScanning = csp.Policy{
...
var AllowUserUIAccess = csp.Policy{
...
var AttackSurfaceReductionOnlyExclusions = csp.Policy{
	Name:       "AttackSurfaceReductionOnlyExclusions",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/AttackSurfaceReductionOnlyExclusions",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
...
var AttackSurfaceReductionRules = csp.Policy{
	Name:       "AttackSurfaceReductionRules",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/AttackSurfaceReductionRules",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.16299",
	CSPVersion: "6.0",
...
var AvgCPULoadFactor = csp.Policy{
...
var CheckForSignaturesBeforeRunningScan = csp.Policy{
...
var CloudBlockLevel = csp.Policy{
...
var CloudExtendedTimeout = csp.Policy{
...
var ControlledFolderAccessAllowedApplications = csp.Policy{
	Name:       "ControlledFolderAccessAllowedApplications",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/ControlledFolderAccessAllowedApplications",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.16299",
	CSPVersion: "6.0",
...
var ControlledFolderAccessProtectedFolders = csp.Policy{
	Name:       "ControlledFolderAccessProtectedFolders",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/ControlledFolderAccessProtectedFolders",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.16299",
	CSPVersion: "6.0",
...
var DaysToRetainCleanedMalware = csp.Policy{
...
var DisableCatchupFullScan = csp.Policy{
...
var DisableCatchupQuickScan = csp.Policy{
...
var EnableControlledFolderAccess = csp.Policy{
	Name:       "EnableControlledFolderAccess",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/EnableControlledFolderAccess",
	Format:     "int",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	Default:    "0",
	MinOSBuild: "10.0.16299",
...
var EnableLowCPUPriority = csp.Policy{
...
var EnableNetworkProtection = csp.Policy{
...
var ExcludedExtensions = csp.Policy{
	Name:       "ExcludedExtensions",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/ExcludedExtensions",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.14393",
	CSPVersion: "4.1",
...
var ExcludedPaths = csp.Policy{
	Name:       "ExcludedPaths",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/ExcludedPaths",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.14393",
	CSPVersion: "4.1",
...
var ExcludedProcesses = csp.Policy{
	Name:       "ExcludedProcesses",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/ExcludedProcesses",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.14393",
	CSPVersion: "4.1",
...
var RealTimeScanDirection = csp.Policy{
...
var ScheduleQuickScanTime = csp.Policy{
...
var ScheduleScanDay = csp.Policy{
...
var ScheduleScanTime = csp.Policy{
...
var SecurityIntelligenceLocation = csp.Policy{
	...
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/SecurityIntelligenceLocation",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
...
var SignatureUpdateFallbackOrder = csp.Policy{
	...
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/SignatureUpdateFallbackOrder",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.17763",
	CSPVersion: "8.0",
...
var SignatureUpdateFileSharesSources = csp.Policy{
	Name:       "SignatureUpdateFileSharesSources",
	URI:        "./Device/Vendor/MSFT/Policy/Config/Defender/SignatureUpdateFileSharesSources",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.17763",
	CSPVersion: "8.0",
...
var SignatureUpdateInterval = csp.Policy{
...
var SubmitSamplesConsent = csp.Policy{
...
var ThreatSeverityDefaultAction = csp.Policy{
