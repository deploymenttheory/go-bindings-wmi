...
// AccessCredentialManagerAsTrustedCaller: This user right is used by Credential Manager during Backup/Restore. No accounts should have this privilege, as it is only assigned to Winlogon. Users' saved credentials might be compromised if this privilege is given to other entities.
var AccessCredentialManagerAsTrustedCaller = csp.Policy{
...
var AccessFromNetwork = csp.Policy{
...
var ActAsPartOfTheOperatingSystem = csp.Policy{
...
var AdjustMemoryQuotasForProcess = csp.Policy{
	Name:       "AdjustMemoryQuotasForProcess",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/AdjustMemoryQuotasForProcess",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
...
var AllowLocalLogOn = csp.Policy{
...
var AllowLogOnThroughRemoteDesktop = csp.Policy{
	Name:       "AllowLogOnThroughRemoteDesktop",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/AllowLogOnThroughRemoteDesktop",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.26100, 10.0.22621.5126",
	CSPVersion: "11.0",
...
var BackupFilesAndDirectories = csp.Policy{
...
var BypassTraverseChecking = csp.Policy{
	Name:       "BypassTraverseChecking",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/BypassTraverseChecking",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.26100, 10.0.22621.5126",
	CSPVersion: "11.0",
...
var ChangeSystemTime = csp.Policy{
...
var ChangeTimeZone = csp.Policy{
	Name:       "ChangeTimeZone",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/ChangeTimeZone",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.26100, 10.0.22621.5126",
	CSPVersion: "11.0",
...
var CreateGlobalObjects = csp.Policy{
...
var CreatePermanentSharedObjects = csp.Policy{
...
var CreateSymbolicLinks = csp.Policy{
...
var DenyAccessFromNetwork = csp.Policy{
...
var DenyLogOnAsBatchJob = csp.Policy{
...
var DenyLogOnAsService = csp.Policy{
...
var DenyRemoteDesktopServicesLogOn = csp.Policy{
...
var EnableDelegation = csp.Policy{
...
var GenerateSecurityAudits = csp.Policy{
...
var ImpersonateClient = csp.Policy{
...
var IncreaseProcessWorkingSet = csp.Policy{
	Name:       "IncreaseProcessWorkingSet",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/IncreaseProcessWorkingSet",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.26100",
	CSPVersion: "11.0",
...
var IncreaseSchedulingPriority = csp.Policy{
...
var LoadUnloadDeviceDrivers = csp.Policy{
...
var LogOnAsBatchJob = csp.Policy{
	Name:       "LogOnAsBatchJob",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/LogOnAsBatchJob",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.26100, 10.0.22621.5126",
	CSPVersion: "11.0",
...
var LogOnAsService = csp.Policy{
	Name:       "LogOnAsService",
	URI:        "./Device/Vendor/MSFT/Policy/Config/UserRights/LogOnAsService",
	Format:     "chr",
	Access:     []string{"Add", "Delete", "Get", "Replace"},
	MinOSBuild: "10.0.26100, 10.0.22621.5126",
	CSPVersion: "11.0",
...
var ManageAuditingAndSecurityLog = csp.Policy{
...
var ModifyFirmwareEnvironment = csp.Policy{
...
var ModifyObjectLabel = csp.Policy{
...
var ProfileSingleProcess = csp.Policy{
...
var ProfileSystemPerformance = csp.Policy{
...
var ReplaceProcessLevelToken = csp.Policy{
...
var RestoreFilesAndDirectories = csp.Policy{
...
var ShutDownTheSystem = csp.Policy{
