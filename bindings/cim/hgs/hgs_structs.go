...
type MSFTHgsGuardian struct {
	...
	GuardianMetadataVersion                 uint32  `cim:"GuardianMetadataVersion"`
	HasPrivateSigningKey                    bool    `cim:"HasPrivateSigningKey"`
	Name                                    string  `cim:"Name"`
	SigningCertificate                      []uint8 `cim:"SigningCertificate"`
}
